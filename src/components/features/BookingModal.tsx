...
// --- CONFIGURATION ---
const CALENDLY_URL = "https://calendly.com/your-username/30min"; // Replace dynamically
const MODAL_TITLE = "Schedule Your Consultation";
                    ...
                    <div className="fixed inset-0 z-[60] flex items-center justify-center p-4 sm:p-6">
                        ...
                        >
                            <div className="flex items-center justify-between p-4 border-b border-zinc-200 dark:border-zinc-800">
                                <h3 className="font-semibold text-lg text-zinc-900 dark:text-white">{MODAL_TITLE}</h3>
                                <button
                                    onClick={() => setIsOpen(false)}
