        ...
        <div className="fixed bottom-24 right-4 z-40 hidden md:block">
            <AnimatePresence>
                {isOpen && (
                    ...
                    >
                        <h4 className="font-semibold mb-3 text-sm">Accessibility</h4>

                        <div className="space-y-4">
                            <div>
                                <label className="text-xs text-zinc-500 mb-1 block">Text Size</label>
                            ...
                            <div>
                                <label className="text-xs text-zinc-500 mb-1 block">Contrast</label>
                                <Button
                                    size="sm"
