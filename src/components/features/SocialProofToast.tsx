...
// --- CONFIGURATION ---
const NOTIFICATIONS = [
    "Maria from CDMX just booked a consultation.",
    "Carlos from Monterrey signed up for the Starter Plan.",
    "LegalPros Inc. upgraded to Enterprise.",
    "Sofia requested a free audit."
];
            ...
            {isVisible && (
                ...
                >
                    ...
                    <div>
                        ...
                        <p className="text-xs text-zinc-400 mt-1">Just now</p>
                    </div>
                </motion.div>
            )}
        </AnimatePresence>
